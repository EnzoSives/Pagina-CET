              ...
              <template v-if="props.deporte === 'Ciclismo'">
                <div class="col-12">
                  <q-btn
                    ...
                    @click="
                      goTo(
                        'https://www.mercadopago.com.ar/checkout/v1/payment/redirect/?source=link&preference-id=251794130-0dc1b341-680a-4bd4-becd-c9e70c805917&router-request-id=3b390056-de85-4fd7-9ff3-339fbc15fb3f',
                      )
                    "
                ...
                <div class="col-12">
                  <q-btn
                    ...
                    @click="
                      goTo(
                        'https://www.mercadopago.com.ar/checkout/v1/payment/redirect/?source=link&preference-id=251794130-a173d1aa-9683-4be0-9d94-82e73a294da5&router-request-id=89c76a51-347b-4d82-88b0-f894e83f9d14',
                      )
                    "
                    icon="pedal_bike"
                  />
...
const calendarUrls: Record<string, string> = {
  Patin:
    'https://calendar.google.com/calendar/embed?src=enzosives7%40gmail.com&ctz=America%2FArgentina%2FBuenos_Aires',
  Hockey:
    'https://calendar.google.com/calendar/embed?src=enzosives7%40gmail.com&ctz=America%2FArgentina%2FBuenos_Aires',
  Ciclismo:
    'https://calendar.google.com/calendar/embed?src=enzosives7%40gmail.com&ctz=America%2FArgentina%2FBuenos_Aires',
